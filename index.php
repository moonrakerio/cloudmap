    ...
    <body>
                    ...
                    <div class="col-lg-12" style="padding-top: 7px;">
                        <div class="col-sm-1 pull-right">
                            <div class="input-group">
                                <a href="addedit.php" type="button" class="btn btn-default">Add New Entry</a>
                            </div>
                        </div>
        ...
        <div id="body_id">
            ...
            <div id="right_panel" class="col-sm-9">
                ...
                <div id="map_model">
                    <div id="closelabDiv"><button id="closelab" onclick="closeinfo()" value="X" style="">X</button></div>
                ...
                <div id="list" class="col-sm-12">
                    <table id="showdataT" class="table table-striped">
                        ...
                        <thead> <tr> <th>Provider</th> <th>Region</th> <th>Location</th> <th>Ratting</th><th></th></tr> </thead> 
                        <tbody id="showdataC"> 
                            <tr id="1"> 
                                ...
                                <td><a href="" type="button"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
                            </tr>
                            <tr>
                            ...
                            <tr> <th scope="row">Rackspace</th> 
                                ...
                                <td><a href="addedit.php?id=" type="button"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
                            </tr> 
                        </tbody>
                    </table>
                </div>
                    ...
                    function showData(data) {
                        ...
                        $.each(resp["data"], function (key, val) {
                            ...
                            str += '<tr id="' + val.id + '"  onclick="loadcomp(' + val.id + ')"><th scope="row">' + val.com + '</th><td>' + val.loc + '</td> <td>' + val.reg + '</td>  \
                                                        <td><h3 style="margin: 0;"><span class="glyphicon glyphicon-star lab_yel"></span><span class="glyphicon glyphicon-star lab_yel"></span><span class="glyphicon glyphicon-star lab_yel"></span><span class="glyphicon glyphicon-star lab_yel"></span><span class="glyphicon glyphicon-star"></span></h3></td> \
                                                   <td><a href="addedit.php?id=' + val.id + '" type="button"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td></tr>';
                                    ...
                                    $.each(resp[0], function (key, val) {
                                        if (isNaN(key)) {
                                            if (key != 'id' && key != 'Company' && key != 'Lat' && key != 'Lon' && key != 'Region') {
                                                if (val != '' && val != ' ' && val.length > 1 && val != 'Unknown') {
                                                    var kKey = key.split('_').join(' ');
                                                    strC += '<div class="row" style=""><div class="col-sm-6" style="text-align: left;"><b>' + kKey + ':</b></div> \
                                                            <div class="col-sm-6" style="text-align: left;">' + val + '</div></div>';
